...
| **Frontend** | 7.4.4 Отрисовка гео-точек и остановок | Кирилл | 🟡 P1 | `MapView.tsx`, `telemetry.ts` | ✅ Реализован (остановки М3, пересадки на метро, зона риска Бауманская-Семёновская) |
| **Frontend** | 7.4.5 QA-стабилизация (7 дефектов) | Кирилл | 🔴 P0 | 7.4.1–7.4.4 | 🛠 В работе (выявлены в интерактивной QA-сессии) |
