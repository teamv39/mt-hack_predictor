...
* **Дефект 5 (Смятые кнопки управления в TopBar):** Кнопки `10 15 x5 x10` сплющены в правом углу без паддингов.
  * *Решение:* Оформить аккуратный кнопочный блок управления скоростью симуляции с иконками и разделителями.
