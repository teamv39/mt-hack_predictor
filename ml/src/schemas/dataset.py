...
class TrafficPoint(BaseModel):
    ...
    device_event_id: Optional[str] = Field(default=None, description="On-board device event identifier")
    location_valid: bool = Field(default=False, description="Whether lon/lat/speed are trustworthy")
    gps_time: Optional[datetime] = Field(
        default=None, description="Timestamp generated by on-board GPS receiver"
    )
    lon: Optional[float] = Field(default=None, ge=-180.0, le=180.0, description="Longitude in WGS84 degrees")
    lat: Optional[float] = Field(default=None, ge=-90.0, le=90.0, description="Latitude in WGS84 degrees")
    ...
    receive_time: Optional[datetime] = Field(default=None, description="Server reception timestamp")
    ...
    @classmethod
    def _empty_dt_to_none(cls, value: Any) -> Any:
        if value is None or value == "":
            return None
        return value
...
class ScheduleStop(BaseModel):
    ...
    manual_fill: Optional[bool] = Field(
        default=None, description="Flag indicating schedule entry was manually inputted/adjusted"
    )
    ...
    @classmethod
    def _empty_fact_to_none(cls, value: Any) -> Any:
        if value is None or value == "":
            return None
        return value
    ...
    @classmethod
    def _parse_manual(cls, value: Any) -> Any:
        if value is None or value == "":
            return None
        if isinstance(value, bool):
            return value
