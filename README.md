...
| **5** | **Производительность и надёжность** | **0–4** | Go-бэкенд с микросекундным latency, прием NDTP по TCP, WebSocket broadcast, деградация без падений при потере связи. |
